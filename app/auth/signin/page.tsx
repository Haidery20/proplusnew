...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setIsLoading(false)
      // Redirect to provider dashboard or booking page
      alert("Sign in successful! Redirecting to provider booking...")
    }, 2000)
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="font-outfit">Welcome back</CardTitle>
            <CardDescription className="font-hanken">
              Enter your credentials to access your account and book consultations with our providers.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-sm text-gray-900 font-hanken">
                    Remember me
                  </label>
                </div>
                ...
                <div className="text-sm">
                  <Link
                    ...
                    className="font-medium text-primary hover:text-primary/80 font-hanken"
                  >
